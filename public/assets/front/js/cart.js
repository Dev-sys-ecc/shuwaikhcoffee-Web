                    ...
                    for (let i = 0; i < options.length; i++) {
                        variants += `<div class="form-check d-flex justify-content-between ${(i == (options.length - 1)) ? 'border-0' : ''}">
                            <div>
                                ...
                                <label class="form-check-label" style=${rtl && ("margin-right:50px")} for="voption${iopt}">${options[i].name}</label>
                            </div>
                ...
                for (let i = 0; i < addons.length; i++) {
                    addonHtml += `<div class="form-check d-flex justify-content-between">
                        <div>
                            ...
                            <label class="form-check-label" style=${rtl && ("margin-right:50px")} for="addon${i}">
                            ${addons[i].name}
                            </label>
                        </div>
                        <span style=${rtl && ("direction:ltr")}>
