...
Route::post('/payment-response',[\App\Http\Controllers\Payment\product\OfflineController::class , 'responseKentUrl'])->name('payment.response');

Route::post('/payment-error', [\App\Http\Controllers\Payment\product\OfflineController::class , 'ErrorKentUrl'])->name('payment.error');
...
Route::middleware(['setlang'])->group(function () {
	...
	// Route::get('/compress-images', 'Front\FrontendController@compressImagesInPublicUploads');
    ...
    Route::post('wishlist/store', [ProductController::class , 'wishlistStore'])->name('wishlist.store');
    Route::post('wishlist/delete', [ProductController::class , 'wishlistDelete'])->name('wishlist.delete');
...
Route::get('/{slug}/{id}/item', [ProductController::class, 'ProductPageDetails'])->name('front.product.details');
Route::get('/{id}/offer', [ProductController::class, 'offerPageDetails'])->name('front.offer.details');
Route::get('/offers', [\App\Http\Controllers\Front\ProductController::class, 'offers'])->name('front.offers.show');
...
Route::get('autosearch' , [\App\Http\Controllers\Front\FrontendController::class , 'autosearch'])->name('autosearch');
Route::get('search' , [\App\Http\Controllers\Front\FrontendController::class , 'search' ])->name('search');
...
Route::group(['middleware' => ['auth:web', 'userstatus']], function () {
    Route::get('/dashboard', 'User\UserController@index')->name('user-dashboard');

    Route::get('/profile', 'User\UserController@profile')->name('user-profile');
    Route::get('/edite-profile', 'User\UserController@EditeProFile')->name('edite-user-profile');
    Route::post('/profile/submit', 'User\UserController@profileupdate')->name('user-profile-update');
...
Route::get('/hesabe-payment/{id}' ,[\App\Http\Controllers\Payment\PaymentController::class , 'initiatePayment'] )->name('hesabePayment');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
    ...
    Route::group(['middleware' => 'checkpermission:Product Management'], function () {
        ...
        Route::get('/offer/{id}/edit', 'Admin\OfferController@edit')->name('admin.offer.edit');
        Route::get('/offer/unsubscribe/{offer}/{user}', [\App\Http\Controllers\Admin\OfferController::class , 'unsubscribe'])->name('admin.offer.unsubscribe');
        Route::post('/offer/update', 'Admin\OfferController@update')->name('admin.offer.update');
        Route::post('/offer/delete', 'Admin\OfferController@delete')->name('admin.offer.delete');
        ...
        Route::post('/offer/bulk-delete', 'Admin\OfferController@bulkDelete')->name('admin.offer.bulk.delete');

        Route::post('/offer/feature', 'Admin\OfferController@FeatureCheck')->name('admin.offer.feature');
    });
