                    ...
                    <div class="payment-information">
                        @if (!empty($order->shipping_fname))
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-6">
                                {{convertUtf8($order->shipping_fname)}}
                                </div>
                            </div>
                        @endif
                        ...
                        @if (!empty($order->shipping_number))
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-6">
                                    {{$order->shipping_country_code}}{{$order->shipping_number}}
                                </div>
                            </div>
                        @endif
...
@if (!empty($variations))
    ...
    @if (is_array($variations))
        @if (isset($variations['size']))
            <span class="text-capitalize">{{ $variations['size']['name'] }}</span>
		@endif
    @else
        <span class="text-capitalize">{{ $variations["name"] }}</span>
    @endif
    <br>
@endif
