                    ...
                    <div class="row no-gutters">
                        <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="date" class="form-control " name="start_date" value="{{$coupon->start_date}}" placeholder="Enter start date" autocomplete="off">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="date" class="form-control " name="end_date" value="{{$coupon->end_date}}" placeholder="Enter end date" autocomplete="off">
