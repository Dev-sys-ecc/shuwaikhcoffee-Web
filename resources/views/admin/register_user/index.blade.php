                                        ...
                                        <tbody>
                                            @foreach ($users as $key => $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{implode(', ', $user->offers->pluck('title')->toArray())}}
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('register.user.view', $user->id) }}">Details</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('register.user.changePass', $user->id) }}" target="__blank">Change
                                                                    Password</a>
                                                                <form class="d-block"
                                                                    action="{{ route('admin.secretLogin') }}"
